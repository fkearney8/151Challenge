...
class AggregateDataHelperSpec extends Specification {
  "AggregateDataHelper" should {
    "find the earliest shot taken date" in {
      ...
      val exerciseEntries = List(ExerciseEntry(1, ExerciseType.Shot, 1, calFromDaysAgo(0), 1, ""),
        ExerciseEntry(1, ExerciseType.Shot, 1, dayEarliestShotTaken, 1, ""),
        ExerciseEntry(1, ExerciseType.Shot, 1, calFromDaysAgo(1), 1, ""))
